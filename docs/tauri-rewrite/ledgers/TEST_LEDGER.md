...
T-006 and T-007 are IMPLEMENTED, not PARITY-TESTED. They are unit tests written
from the shipped `Device.cs` and its three test files, not artifacts generated by
the frozen C# oracle the way `qcm-config` parity works. They move to
