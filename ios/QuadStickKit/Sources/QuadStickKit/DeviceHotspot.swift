...
public enum DevicePhoto {
    ...
    private static func at(_ inputID: String, _ pointX: Double, _ pointY: Double) -> DeviceHotspot {
    ...
    public static let hotspots: [DeviceHotspot] = [
        at("left-tube", 218, 224),
        at("center-tube", 273, 224),
        at("right-tube", 327, 224),
        at("side-tube", 407, 222),      // the bore of the side tube, not its body
        ...
        DeviceHotspot(inputID: "joystick", x: 0.306, y: 0.625),
        at("lip-switch", 269, 286),
    ]
